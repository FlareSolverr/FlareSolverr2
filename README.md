...
⚠ This repository contains the code of FlareSolverr v2. For the latest release check [https://github.com/FlareSolverr/FlareSolverr](https://github.com/FlareSolverr/FlareSolverr). This repository is not maintained.
